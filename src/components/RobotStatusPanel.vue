      ...
      <div class="banner-wrapper">
        <div class="banner-content">
          <div class="banner-amount-box">
            ...
            />
            <span class="banner-amount">{{ totalAmount }}</span>
          </div>
          <p class="banner-label">资金总量（运行中）</p>
        </div>
      </div>
    </div>
    ...
    <div class="list-container">
      <div class="list-content">
        <div class="list-header">
          ...
          <!--          </span>-->
          <!--          </div>-->
          <rTabs v-model="activeFilter" :tabs="[
            ...
            >
              ...
              <div class="activity-name">
                <img class="activity-icon"
                     :class="activity.type === '数据机器人' ? 'icon-data' : 'icon-strategy'"
                     :src="activity.type === '数据机器人' ? require('../assets/ic/robotdata_tab_default.png'):require('../assets/ic/robotdecision_tab_click.png')"
                />
...
.list-tab.active {
  ...
  line-height: 24px;
  font-weight: 400;
  background: rgba(115, 60, 233, 0.10);
}
